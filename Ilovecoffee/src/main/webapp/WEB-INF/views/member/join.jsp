...
$(function() {
   ...
   $("#signup").on("click", function(){
      ...
      if (name == null || name == "") {
         ...
         $("#userid").focus();
         return;
      }else if(!validate_userid(userid) || userid.length<3){
...
<!-- 실제작업 공간 시작 -->
	<!-- 메인헤더 -->
		<div class="container-fluid page-header mb-5 position-relative overlay-bottom">
		    <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5">
		        <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">Join</h1>
		        <div class="d-inline-flex mb-lg-5">
		            <p class="m-0 text-white"><a class="text-white" href="">Home</a></p>
		            <p class="m-0 text-white px-2">/</p>
		            <p class="m-0 text-white">Join</p>
		        </div>
		    </div>
		</div>
	<!-- 메인헤더 끝-->
	<div class="wrapper">
		<form id="frm" action="/member/join" method="post">
			...
			<input type="hidden" id="idCheckResult" name="idCheckResult" value="false">
			
			<div>
			<label>아이디</label>
			<input type="text" id="userid" name="userid" class="id_input" placeholder="id">
			...
			<br><br>
			<div>
			<input type="button" class="overlay_btn" id="signup" name="signup" value="Join">
			</div>
			<br>
		</form>
	</div>
